  ...
  return (
    ...
    <div className='bg-[#ffffff] w-full max-w-screen-md 2xl:max-w-screen-lg mx-auto'>
      <div className='translate-y-[-120%] absolute translate-x-[-50%] left-[50%]'>
        <h1 className='text-center text-[#ffffff] font-medium text-[10px] md:*:text-[30px] xl:text-[40px] font-["Tenor Sans"] px-0 md:px-[1rem]'>
      ...
      <div data-aos="fade-right" className='py-5 md:py-10'>
        <h1 className='text-center text-[#1D2E5C] font-medium text-[30px] font-["Tenor Sans"]'>
          Open Position
        </h1>
        <h1 className='text-center text-[#1D2E5C] font-medium text-[20px] font-["Tenor Sans"]'>
      ...
      <main>
        <div data-aos="fade-left" className='bg-[#ECF1F5] p-10 grid grid-cols-1 gap-3 md:grid-cols-2 md:justify-center'>
            <div className='text-[#1D2E5C] font-medium font-["Tenor Sans"]'>
