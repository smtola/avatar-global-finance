  ...
  return (
    ...
    <Scroll />
      ...
      <div className='container w-full max-w-screen-md xl:max-w-screen-lg mx-auto px-5 md:px-0'>
          <div className="text-center text-[#1D2E5C] font-['Tenor Sans'] my-10">
      ...
      <div className='relative flex w-full z-[999]' data-aos="zoom-in">
        ...
        <div className='hidden lg:block'>
          <div className='bg-gradient-to-r from-[#002561] to-[#1D2E5C] opacity-[0.85] w-full  md:max-w-[28rem] lg:max-w-[36rem] xl:max-w-[45rem] 2xl:max-w-[62rem] absolute top-20 md:top-8 lg:top-14 translate-x-[-50%] left-[50%] md:left-[71.9%]'>
            <div className='p-[35px] xl:p-[60px] text-[#ffffff] font-["Tenor Sans"] z-[10]'>
      ...
      <div className='z-[10] px-2 lg:px-0 my-[10vw] font-["Tenor Sans"]'>
      ...
      <div className='bg-why-us'>
        <h1 className='text-[30px] lg:text-[50px] font-["Tenor Sans"] font-medium text-center py-5 text-[#1D2E5C]'>Why Us?</h1>
        ...
        <div className='w-full max-w-screen-md xl:max-w-screen-lg 2xl:max-w-screen-2xl mx-auto '>
          <div data-aos="zoom-in"
            ...
            <div className='flex gap-2 text-start md:flex-col p-[5px] xl:p-[2vw] 2xl:p-[4vw] md:text-center text-[#ffffff] font-["Tenor Sans"] hover:bg-[#ffffff] hover:shadow-xl hover:scale-[1.1] hover:text-[#1D2E5C] hover:first-line:text-[#068BFF] transition-all duration-150 '>
