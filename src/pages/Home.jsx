...
His Excellency held a L.L.B (Royal University of Law and Economics – Faculty of Law in Cambodia) and a L.L.M (Yokohama National University – Faculty of International Business Law in Japan). He was member of the Bar of the Kingdom of Cambodia. He was appointed as the member of Legal and Justice Council of the Ministry of Justice. He experienced in commercial contract law, Corporate Commercial, Mergers & Acquisition and Restructuring & Insolvency and a well-known law professor at various universities in the Kingdom. He has extensive experiences in legal advises in the field of Real Estate, Corporate & Tax, Trust Law and Mediation Dispute Resolution. He speaks Khmer, English, and Chinese.
      ...
      <div className='z-[10] px-2 lg:px-0 my-[10vw] font-["tenorsans"]'>
        <div className="w-full max-w-screen-md md:px-5 lg:max-w-screen-xl mx-auto">
          ...
          <h1 className="text-[#1D2E5C] text-[20px] md:text-[34px]">I. Founder</h1>
          <div
            data-aos="fade-up"
          ...
          >
            ...
            <div className="py-5 lg:py-0 w-full max-w-2xl mx-auto">
              ...
              Our Firm was formed by H.E. SENG BUN HUY and his role as the President with the specialist in commercial practice, notary public profession, insolvency administrator and governmental mediator of the Ministry of Justice.      
...
His Excellency held a L.L.B (Royal University of Law and Economics – Faculty of Law in Cambodia) and a L.L.M (Yokohama National University – Faculty of International Business Law in Japan). He was member of the Bar of the Kingdom of Cambodia. He was appointed as the member of Legal and Justice Council of the Ministry of Justice. He experienced in commercial contract law, Corporate Commercial, Mergers & Acquisition and Restructuring & Insolvency and a well-known law professor at various universities in the Kingdom. He has extensive experiences in legal advises in the field of Real Estate, Corporate & Tax, Trust Law and Mediation Dispute Resolution. He speaks Khmer, English, and Chinese.
          ...
          <h1 className="text-[#1D2E5C] text-[20px] md:text-[34px]">II. Management</h1>
          <div
            data-aos="fade-up"
            className="bg-[#ECF1F5] flex flex-wrap lg:flex-nowrap justify-center items-center rounded-xl lg:rounded-full my-10 overflow-hidden px-3 md:px-12"
          >
...
He held a BA in Accounting and Finance (Royal University of Law and Economics – Faculty of Accounting in Cambodia). He is also accredited by National Tax School and qualified as Tax Agent of the Ministry of Economics and Finance. He experienced in tax litigation. He has extensive experiences in legal advises in the field of Tax Law and Accounting Practice across the Countries. He speaks Khmer and English.
          ...
          >
            ...
            <div className="py-5 lg:py-0  w-full max-w-2xl">
              ...
              <p className="text-[14px] xl:text-[16px] text-[#1D2E5C]">
              is our partner with the specialist in accounting and auditing practice. He has successfully completed a program at Preah Kossomak Polytechnic Institute and is currently pursuing a Master's degree in Accounting and Auditing at Vanda Institute. He has gained valuable qualifications, including completing an English course and Microsoft Office Word 2013. He experienced working as a contract staff member at the General Department of Tax and served as Production Engineer and Stock Controller at MinebeaMitsumi (Cambodia).
              </p>
            </div>
          </div>
        ...
        <div className="w-full max-w-screen-md md:px-5 lg:max-w-screen-xl mx-auto">
          <h1 className="text-[#1D2E5C] text-[20px] md:text-[34px]">III. Accounting Staffs</h1>
          <div className="w-full max-w-screen-md md:px-3 xl:max-w-screen-lg 2xl:max-w-screen-xl mx-auto grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 justify-center items-center gap-[4vw] pt-7">
            ...
            >
              ...
              <p className="text-[#828386] text-[12px] md:text-[16px]">Senior Accountant</p>
            ...
            >
              ...
              <p className="text-[#828386] text-[12px] md:text-[16px]">Accountant</p>
              <div className="border-b-2 border-[#1D2E5C]"></div>
            </div>
            ...
            >
              ...
              <p className="text-[#828386] text-[12px] md:text-[16px]">Assistant Account</p>
              <div className="border-b-2 border-[#1D2E5C]"></div>
            </div>
          </div>

          <h1 className="text-[#1D2E5C] text-[20px] md:text-[34px] my-10">IV. Admin Staffs</h1>
          <div className="w-full max-w-screen-md md:px-3 xl:max-w-screen-lg 2xl:max-w-screen-xl mx-auto grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 justify-center items-center gap-[4vw] pt-7">
            <div
              data-aos="zoom-in"
