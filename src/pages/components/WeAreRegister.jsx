  ...
  return (
    ...
    <div className='w-full max-w-screen-lg mx-auto text-[#1D2E5C] pb-0 md:pb-24 pt-5'>
      <div data-aos="fade-right">
        <h1 className='text-center font-medium text-[20px] md:text-[30px] font-["Tenor Sans"] px-[10px] md:px-[15vw]'>
          Our entity is completely registered,
          and we fully obtained
        </h1>
        <br/>
        <p className='text-center text-[16px] md:text-[20px] font-medium font-["Tenor Sans"] px-[8vw]'>
          Tax Agent License
