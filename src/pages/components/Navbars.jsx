          ...
          <div className='lg:flex justify-center gap-4 hidden'>
            <div className='grid'>
              <div className='flex justify-center gap-2'>
                ...
                <b className='font-["inter"] text-[12px] 2xl:text-[16px] text-[#1D2E5C]'>AVATAR ACCOUNTING & FINANCE</b>
              </div>
              <div className='flex gap-2'>
                ...
                <b className='font-["inter"] text-[12px] 2xl:text-[16px] text-[#1D2E5C]'>AVATAR Cambodia</b>
              </div>
            </div>
            <div className='flex gap-2'>
              <span>
              ...
              <b className='font-["inter"] text-[12px] 2xl:text-[16px] text-[#1D2E5C]'>+855 17 966 659 / +855 69 666 499</b>
            </div>
          </div>
