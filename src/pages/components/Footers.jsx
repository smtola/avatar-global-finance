              ...
              <ul className='font-["tenorsans"] font-medium text-white'>
                ...
                <li data-aos="zoom-in" className='flex gap-2'>
                  <a href='https://t.me/+855 17 600 499' className='hover:scale-[1.2] transition-all duration-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-telegram" width="24" height="24" viewBox="0 0 24 24" stroke-width="1" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
              ...
              {/* <ul className='font-["tenorsans"] font-medium text-white'>
                ...
                <li data-aos="zoom-in" className='flex gap-2 md:justify-start'>
                  <a className='hover:scale-[1.2] transition-all duration-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-facebook" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                      <path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3" />
                    </svg>
                  </a>|
                  <a className='hover:scale-[1.2] transition-all duration-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-linkedin" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                  ...
                  <a className='hover:scale-[1.2] transition-all duration-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-twitter" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
              ...
              <ul className='font-["tenorsans"] font-medium text-white'>
                <li data-aos="zoom-in" className='flex gap-2 my-1'>
                  <a href="tel:+855 12 772 771" className='hover:scale-[1.2] transition-all duration-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-phone" width="24" height="24" viewBox="0 0 24 24" stroke-width="1" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                <li data-aos="zoom-in" className='flex gap-2 my-1'>
                  <a href='mailto:huy@avatar-gfaf.com.kh' className='hover:scale-[1.2] transition-all duration-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-mail" width="24" height="24" viewBox="0 0 24 24" stroke-width="1" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                <li data-aos="zoom-in" className='flex gap-2 my-1'>
                  <a href='https://maps.app.goo.gl/hp14CJubhwVpk5ScA' className='hover:scale-[1.2] transition-all duration-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-map-pin" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
