  ...
  return (
    <>
      <footer className='bg-[#1D2E5C] w-full  mx-auto'>
        <div className='grid grid-cols-2 gap-2 md:grid-cols-3 justify-evenly py-16 px-5'>
          <div className="grid justify-center" data-aos="zoom-in">
            <img src={logoWhite} alt="logo" className='w-[24vh] xl:w-[30vh]'/>
          </div>
          <div className="grid justify-center">
            <h1 className='text-[30px] font-["tenorsans"] font-medium text-white'>Office Contact</h1>
            ...
            <h1 className='text-[30px] font-["tenorsans"] font-medium text-white mt-2'>Follow Us</h1>
            <ul className='font-["tenorsans"] font-medium text-white'>
              <li data-aos="zoom-in" className='flex gap-2'>
                <a>
          ...
          <div className="">
            <h1 className='text-[30px] font-["tenorsans"] font-medium text-white'>Operation Contact</h1>
            <ul className='font-["tenorsans"] font-medium text-white'>
              <li data-aos="zoom-in" className='flex gap-2'>
                <span>
